...
* <label><input type="checkbox" /> Habilitar la autenticación de 2 pasos ([Google Authenticator](https://wordpress.org/plugins/google-authenticator/){:target="_blank"})</label>
* <label><input type="checkbox" /> Utilice el correo electrónico para iniciar sesión en lugar de un nombre de usuario ([Force Login With Email](https://wordpress.org/plugins/force-login-with-email/){:target="_blank"})</label>
