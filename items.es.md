...
* <label><input type="checkbox" data-item-id="wsc-hosting-permissions-755-644" /> Establecer permisos 755 para carpetas y 644 para archivos ([según la documentación](https://developer.wordpress.org/advanced-administration/security/hardening/){:target="_blank" rel="noopener noreferrer"})</label>
